...
TBENCH_QPS=${QPS} TBENCH_MAXREQS=${MAXREQS} TBENCH_WARMUPREQS=${WARMUPREQS} TBENCH_MINSLEEPNS=1000 TBENCH_RANDSEED=0 ./out-perf.masstree/benchmarks/dbtest_integrated --verbose \
