...
paths = [r"../img-dnn/lats.bin", r"../masstree/lats.bin", r"../silo/lats.bin", r"../specjbb/lats.bin",
         r"../sphinx/lats.bin"]
buildStatements = [r"(cd ../harness/ ; sudo ./build.sh)", r"(cd ../ ; sudo ./build.sh harness)",
                   r"(cd ../img-dnn/ ; sudo ./build.sh)", r"(cd ../masstree/ ; sudo ./build.sh)",
                   r"(cd ../silo/ ; sudo ./build.sh)", r"(cd ../specjbb/ ; sudo ./build.sh)",
                   r"(cd ../sphinx/ ; sudo ./build.sh)"]
executeStatements = [r"(cd ../img-dnn/ ; sudo ./run.sh)", r"(cd ../masstree/ ; sudo ./run.sh)",
                     r"(cd ../silo/ ; sudo ./run.sh)", r"(cd ../specjbb/ ; sudo ./run.sh)",
                     r"(cd ../sphinx/ ; sudo ./run.sh)"]
